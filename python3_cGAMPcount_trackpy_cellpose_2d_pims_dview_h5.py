...
#    virus=0
    ...
    cGAMPsum  = ndi.sum(rebin(reader[label],(1022,1024)), cells_masks, np.arange(cells_masks.max()+1))
    cGASsum  = ndi.sum(rebin(reader[chan3],(1022,1024)), cells_masks, np.arange(cells_masks.max()+1))
    
    cGAMPmax  = ndi.maximum(rebin(reader[label],(1022,1024)), cells_masks, np.arange(cells_masks.max()+1))
    cGASmax  = ndi.maximum(rebin(reader[chan3],(1022,1024)), cells_masks, np.arange(cells_masks.max()+1))
