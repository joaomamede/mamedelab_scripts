...
#     omexml.image_count = reader.sizes['v']
    ...
    for c in range(p.SizeC):
        ...
        clr = {'miRFP670':  65535 , 'mirfp670':  65535 , 'a647': 65535,'Cy5': 65535,
               ...
               'FITc': 16711935,'GFP': 16711935,'FITC': 16711935,'GREEN-EM': 16711935, '470 nm': 16711935,'FITC (Em)': 16711935,
               'DAPI': 65535,}
...
#                         pixel.Plane(counter).
    ...
    for c in range(p.SizeC):
        ...
        clr = {'mirfp670':  65535 ,'farRED-EM':  65535 , 'miRFP670':  65535 , 'a647': 65535,'630.0': 65535,'670.0': 65535, '699.5': 65535,'679.0': 65535,
               'RED-EM' : -16776961, '555 nm' : -16776961, 'mRuby3' : -16776961, 'mRuby' : -16776961, '590.0' : -16776961,
               '597.0' : -16776961, '606.5':-16776961,
               'GFP': 16711935,'FITC': 16711935,'535.0' : 16711935, '470 nm': 16711935,'523.0': 16711935,'FITC (Em)': 16711935, '525.0' : 16711935,
               'DAPI': 65535,}
...
#     sizeT_local = 0
    ...
    if project:
        ...
        p = writeplanes(p, bfmeta, SizeT=sizeT_local, SizeZ=1, SizeC=p.SizeC, order=dimorder,verbose=True)  ################# concat #########
    else:
        p.PhysicalSizeZ = np.float(scalez)
        p.SizeZ = reader.sizes['z']
